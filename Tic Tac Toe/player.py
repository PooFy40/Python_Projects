        ...
        while not valid_square:
            ...
            try:
                ...
                if val not in game.available_moves():
                    raise ValueError
                valid_square = True # if these are scussful, then yay!
            except ValueError:
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self,state,player):
        ...
        other_player = 'O' if player == 'X' else 'X'  # the other player.. so whatever letter is that
        ...
        for possible_move in state.available_moves():
            ...
            # step 4: update the dictonaries if necessary
